 ...
 * @since 1.0.0
 */
public class MVException extends BaseUncheckedException {
	/**
	 ...
	 */
	public MVException(String errorCode, String errorMessage) {
	 ...
	 */
	public MVException(String errorCode, String errorMessage, Throwable rootCause) {
