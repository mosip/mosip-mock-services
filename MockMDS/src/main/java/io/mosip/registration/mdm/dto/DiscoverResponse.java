...
/**
 * Data Transfer Object (DTO) for response containing discovered response
 * details or error information.
 * 
 * This class is used to represent the response from a device discovery
 * response. The response can either contain details about a discovered device
 * or an error object if no device was found or an error occurred during
 * discovery.
 * 
 * @since 1.0.0
 */
