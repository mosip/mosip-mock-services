...
public abstract class SBICaptureInfo {
	...
	private Map<String, String> biometricData = new HashMap<>();

	protected SBICaptureInfo() {
		super();
	...
	public Map<String, String> getBiometricData() {
		return biometricData;
	}

	public void setBiometricData(Map<String, String> biometricData) {
