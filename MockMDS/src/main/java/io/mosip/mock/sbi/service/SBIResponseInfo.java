...
@SuppressWarnings({ "java:S1192", "java:S1488" })
public class SBIResponseInfo {
	private SBIResponseInfo() {
		throw new IllegalStateException("SBIResponseInfo class");
	}
	...
	public static String generateErrorResponse(String lang, int port, String errorCode, String exceptionMessage) {
		...
		httpResponse += "LOCATION: HTTP://" + ApplicationPropertyHelper.getPropertyKeyValue(SBIConstant.SERVER_ADDRESS)
				+ ":" + port + "/\r\n";
	...
	public static String generateAdminApiErrorResponse(String lang, int port, String errorCode,
	...
	private static String getAccessControlAllowMethods() {
		String accessHeaders = "Access-Control-Allow-Methods: "
